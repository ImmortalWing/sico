...
> Status: entry satisfied; S1/S2/S3 partial, S4 partial through STEP-0241; S5 deterministic Component codegen and S6 ADR-0015 A=B=C bootstrap not entered. STEP-0193–0223 built a bounded lowering subset with 69 hand-selected byte-differential fixtures; STEP-0241 repaired a silent shadowing divergence and a diagnostic-identity defect. These fixtures do not substitute for the frozen-corpus gates below.
