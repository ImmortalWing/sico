...
> - status: in progress (STEP-0027 complete)
> - created: 2026-07-15
> - phase: M2
...
进度：STEP-0027 已完成；revision 的 2/2 valid 与 2/2 invalid exact primary diagnostics 见 [`review report`](../reports/revision-contract-dataflow-v0.md)。下一执行项为 STEP-0028。
