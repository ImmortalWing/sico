...
| [`M10 Runtime observability and debugging`](./M10-runtime-observability-debugging.md) | in progress; STEP-0095–0098 complete, STEP-0099 next | source/debug identity, Runtime frames and typed cancellation complete; bounded events, DAP and client integration remain |
| [`M11 bounded structured-concurrency Runtime`](./M11-structured-concurrency-runtime.md) | STEP-0103 ADR design unlocked; implementation after M10 GO | Store/arena ADR, cooperative scheduler, structured tasks, bounded queues, authority-neutral parallelism and Windows/Linux native exit |
