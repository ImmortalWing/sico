...
| [`M10 Runtime observability and debugging`](./M10-runtime-observability-debugging.md) | in progress; STEP-0095–0097 complete, STEP-0098 next | source/debug identity and Runtime frames complete; typed signal cancellation, bounded events, DAP and client integration remain |
