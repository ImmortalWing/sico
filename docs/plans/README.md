...
| [`M10 Runtime observability and debugging`](./M10-runtime-observability-debugging.md) | in progress; STEP-0095 complete, STEP-0096 next | source/debug identity, Runtime frames, typed signal cancellation, bounded events, DAP and client integration |
