...
| [`M8 Script Profile v0`](./M8-script-profile.md) | planned; STEP-0075 in progress | bounded args/stdin/stdout, general executable codegen, Script WIT/adapter/runner, cache and minimal useful standard library |
| [`M9 streaming, async and interactive scripting`](./M9-streaming-async-interactive.md) | planned-after-M8 | streaming resources, Task/Future/Stream backend, scoped HTTP, persistent runner, watch, REPL and top-level syntax decision |
