...
| [ADR-0015](./ADR-0015-compiler-bootstrap-architecture-v0.md) | accepted | M22 byte-exact compiler bootstrap：canonical source bundle、Rust verifier oracle、A=B=C 三代固定点、M7 `.sapp` 信任链与预算重测策略；2026-09-16 owner 指令「完成M22，规划M23-24」接受 |
