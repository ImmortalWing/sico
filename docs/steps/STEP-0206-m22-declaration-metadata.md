# STEP-0206: M22 accepted declaration metadata parity
...
> - artifacts: `selfhost/parser.sico`, `runner/sico-runner/tests/selfhost_parser.rs`, `tools/validate-step-0206.ps1`
...
declarations on all 99 STEP-0201 formatter-accepted sources. Results are
