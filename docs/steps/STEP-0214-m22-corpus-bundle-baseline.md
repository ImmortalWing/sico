# STEP-0214: M22 frozen corpus and canonical source-bundle boundary
...
> - artifacts: `selfhost/corpus-v0.json`, `runner/sico-runner/src/bootstrap.rs`, `runner/sico-runner/tests/bootstrap_bundle.rs`, `tools/update-m22-corpus.ps1`, `tools/validate-step-0214.ps1`
...
This STEP closes only the first item in the STEP-0213 recovery sequence. It does
