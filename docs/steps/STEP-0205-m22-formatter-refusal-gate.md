# STEP-0205: M22 formatter full-corpus refusal gate
...
> - artifacts: `selfhost/formatter.sico`, `runner/sico-runner/tests/selfhost_formatter.rs`, `tools/validate-step-0205.ps1`
...
than corpus paths or a manifest allowlist. Every STEP-0201 source refused by the
