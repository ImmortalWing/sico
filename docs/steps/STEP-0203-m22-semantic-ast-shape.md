# STEP-0203: M22 accepted-corpus semantic AST declaration shape
...
> - artifacts: `selfhost/parser.sico`, `runner/sico-runner/tests/selfhost_parser.rs`, `tools/validate-step-0203.ps1`
...
The real runner executes the Sico parser on every STEP-0201 source accepted by
...
STEP-0200's “real bounded AST” row remains partial, and no formatter, lowering,
