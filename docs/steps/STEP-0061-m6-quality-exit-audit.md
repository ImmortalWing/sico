...
> Sequencing note (2026-07-16): this audit's M6 NO-GO remains authoritative. Its original whole-M7 entry block was narrowed by ADR-0006; platform-independent M7 work may proceed without changing the M6 result or claiming mobile support.
...
- Exact runner recovery matrix is frozen; the original whole-M7 entry block is superseded by ADR-0006 while M6/mobile claims remain blocked.
