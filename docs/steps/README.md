...
| [STEP-0292](./STEP-0292-m22-w1-independent-ci.md) | in progress / remote CI pending（卡 22-A） | M22 compiler self-host — W1 独立裁决 | owner 授权推送；远端 `origin/dev` 已有冲突的 W1/W2 提交，故以独立分支保留双方历史；新增 Windows GNU 远端 CI 工作流，等待精确提交的运行结果后再裁决 W1 |
