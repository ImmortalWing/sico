# STEP-0220: M22 Script v0 build corpus and artifact oracle
...
> - artifacts: `selfhost/script-build-corpus-v0.json`, `selfhost/corpus-v0.json`, `tools/update-m22-corpus.ps1`, `tools/validate-step-0220.ps1`
...
Sico compiler can compile the 37 accepted sources: the bounded IR and codegen seams are
