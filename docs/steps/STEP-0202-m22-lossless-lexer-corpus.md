# STEP-0202: M22 lossless Sico lexer over the frozen corpus
...
> - artifacts: `selfhost/tokens.sico`, `runner/sico-runner/tests/selfhost_tokens.rs`, `tools/validate-step-0202.ps1`
...
215 STEP-0201 sources. The result is 215/215 files green: kind, span and raw
...
This STEP closes the lexer row of the STEP-0200 recovery sequence. It does not
