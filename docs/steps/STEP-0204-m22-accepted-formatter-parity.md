# STEP-0204: M22 accepted-corpus formatter parity
...
> - artifacts: `selfhost/formatter.sico`, `runner/sico-runner/tests/selfhost_formatter.rs`, `tools/validate-step-0204.ps1`
...
The differential test selects all 99 STEP-0201 sources accepted by the Rust
...
gate therefore remain partial. STEP-0203's declaration-shape AST also remains a
