...
> - updated: 2026-09-26 (STEP-0296 22-C S4 local real-runner byte differential passed; formatter canary 23/30 with set_nearest_match / CALL-SHAPE frontier. R3 consecutive stall count 0. S3 independent CI succeeded on f7288b7; S4 independent CI pending. M22 remains NO-GO and the parallel origin/dev history is unmerged.)
