...
> - updated: 2026-09-26 (STEP-0297 independent CI succeeded on ffcdd3f; STEP-0298 CI pending on 5ba175f. STEP-0299 nested map.get key passed local real-runner byte differentials; formatter compilation canary 27/30 with byte-exact direct_close prefix, opener_close / GWSKIP next. R3 consecutive stall count 0. M22 remains NO-GO and the parallel origin/dev history is unmerged.)
