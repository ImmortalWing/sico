...
状态：`in-progress`（STEP-0031 complete）
...
执行计划：[`M3 Sico IR and Component`](./plans/M3-sico-ir-component.md)，STEP-0030–0037；typed IR/verifier 与 core lowering 已完成，下一步 STEP-0032 effect/resource/revision lowering。
