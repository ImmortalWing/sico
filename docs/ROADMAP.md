...
> - updated: 2026-09-26 (STEP-0297 independent CI pending on ffcdd3f; STEP-0298 map.put return and two returning match arms passed local real-runner byte differentials. Formatter canary 24/30 with match_arm_levels / CALL-SHAPE frontier. R3 consecutive stall count 0. M22 remains NO-GO and the parallel origin/dev history is unmerged.)
