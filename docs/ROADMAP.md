...
状态：`in-progress / STEP-0095–0096 complete; STEP-0097 next`
...
执行计划：[`M10 Runtime observability and debugging`](./plans/M10-runtime-observability-debugging.md)，预留 STEP-0095–0102。STEP-0095 已通过 [`RFC-0035`](./rfc/RFC-0035-runtime-observability-debug-v0.md) 与机器 [`observability contracts`](../observability/README.md) 冻结 identity/schema/redaction/race contracts、38 行 DAP allowlist；STEP-0096 已实现 deterministic debug triplet、真实 Core offset/source mapping、generated synthetic rows、atomic CLI 输出与 package roundtrip，并保持普通 build 无 debug link。下一项 STEP-0097 实现 typed Runtime faults/source frames。STEP-0100 必须逐行提供真实 Component 支持证据或 typed refusal。Compiler 只拥有 deterministic debug map；Runtime fault/signal/event 与 DAP 分属 runner/tooling，不允许形成 `compiler → Runtime` 反向依赖。
