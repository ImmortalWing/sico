...
状态：`in-progress / STEP-0103 ADR accepted-design; STEP-0104 semantic/IR contract complete (RFC-0036 accepted); STEP-0105 scheduler core complete; STEP-0106 cancellation/race/select complete; STEP-0107 bounded channels complete; next STEP-0108 persistent-runner/watch/REPL/DAP task integration`
