...
> - date: 2026-09-20 (updated through STEP-0242)
...
| L1 checker declared diagnostic differential | STEP-0242: real-runner 215-source lexical subset is exact (116 `LEXICAL` typed refusals + 99 non-lexical without false classification); 34 semantic/module Rust refusals remain unmatched | **partial** |
...
- `selfhost/checker.sico`: imports the integrated lexer and exactly matches the
  frozen lexical partition; its remaining header report is not canonical Rust
  diagnostics and it does not yet implement the 34 semantic/module refusals.
