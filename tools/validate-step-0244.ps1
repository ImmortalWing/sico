...
foreach ($code in @('E2001', 'E2002', 'E2010', 'E2011', 'E2020')) {
...
if (-not $tests.Contains('(lexical, semantic, accepted, unsupported), (116, 9, 65, 25)')) {
    throw 'full frozen-corpus partition assertion is missing'
}
