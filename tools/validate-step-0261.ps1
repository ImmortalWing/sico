...
try {
    ...
    try {
        ...
        # Current full-source canary: STEP-0294 advances nearest_match to
        # STATEMENT after map.get match-subject lowering.
...
Write-Output 'STEP_0261_OK nested-while=stack-frames parity=17-functions call_left=supported current_canary=NEAREST-MATCH-STATEMENT repinned-by=STEP-0294'
